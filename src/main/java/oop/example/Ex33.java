...
public class Ex33 {
    public static void main(String[] args) {
        ...
        combine that with a random number generator, you can pick a random entry
        from this list, which works great for games.
        Create a Magic 8 Ball game that prompts for a question and then displays
